export const projectsList = [
    {
        bg: 'experiencias',
        title: 'VAN Experiences',
        description: `Este proyecto, desarrollado como parte de mi proyecto final del bootcamp, utiliza NodeJS para el backend y ReactJS para el frontend. En este trabajo, he aplicado todos los conocimientos adquiridos a lo largo del curso para crear una aplicación web funcional y robusta. (No responsive)`,
        links: {
            github: 'https://github.com/vanexperiences/proyecto_experiencias'
        }
    },
    {
        bg: 'pokedexAmf',
        title: 'Pokédex Personal',
        description: `Este proyecto, desarrollado en ReactJS y JavaScript, utiliza la API pública de Pokémon para proporcionar datos dinámicos e interactivos. A través de este proyecto, continúo aprendiendo y practicando nuevas técnicas y funcionalidades de React. (No responsive)`,
        links: {
